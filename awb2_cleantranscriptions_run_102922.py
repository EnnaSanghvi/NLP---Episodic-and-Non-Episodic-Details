# -*- coding: utf-8 -*-
"""AWB2-CLEANtranscriptions-run-102922.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12T-1k6HHTcR5gTtDYYfCAIA1Z2MuNlLF
"""

data_location = '/content/drive/MyDrive/NLP_Project/AWB2-Transcriptions-102922-CLEAN.csv'
output_location = '/content/drive/MyDrive/NLP_Project/'
...
#print(allDat["text"][0])
#allDat["text"][0] = allDat["text"][0][0:20]




for i in range(len(allDat["text"])):
  words = allDat["text"][i].split(" ")
  if len(words) > 392:
      words = words[0:392]
  sentence = " ".join(words)
  allDat["text"][i] = sentence
...
grouped.to_csv(output_location + '/AWB2-cleantrasncriptions-output-102922.csv')

# testData2.to_csv(output_location + '/mock-run-020922_scored_sentence-level.csv')